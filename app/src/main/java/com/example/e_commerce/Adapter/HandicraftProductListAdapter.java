...
public class HandicraftProductListAdapter extends FirestoreRecyclerAdapter<ProductAddModel,HandicraftProductListAdapter.ListViewHolder> {
    /**
     ...
     * @param options
     */
    public HandicraftProductListAdapter(@NonNull FirestoreRecyclerOptions<ProductAddModel> options) {
        super(options);
    }
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.handicraftproductlist,parent,false);
